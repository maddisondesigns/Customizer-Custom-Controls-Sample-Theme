...
class skyrocket_initialise_customizer_settings {
	...
	public function __construct() {
		...
		add_action( 'customize_register', array( $this, 'skyrocket_register_body_text_controls' ) );

		// Register our social media controls
		add_action( 'customize_register', array( $this, 'skyrocket_register_heading_controls' ) );

		// Register our social media controls
		add_action( 'customize_register', array( $this, 'skyrocket_register_h1_heading_controls' ) );
	...
	public function skyrocket_add_customizer_panels( $wp_customize ) {
		...
		/**
		 * Add our Typography Panel
		 */
		 $wp_customize->add_panel( 'typography_panel',
		 	array(
				'title' => __( 'Typography', 'skyrocket' ),
				'description' => esc_html__( 'Configure your fonts.', 'skyrocket' ),
				'priority' => 50,
			)
		);
	}
	...
	public function skyrocket_add_customizer_sections( $wp_customize ) {
		 ...
		 */
		$wp_customize->add_section( 'body_text_section',
			array(
				'title' => __( 'Body Text', 'skyrocket' ),
				'description' => esc_html__( 'Select the font that you\'d like to use for your body text.', 'skyrocket' ),
		 ...
		 */
		$wp_customize->add_section( 'headings_section',
			array(
				'title' => __( 'All Headings', 'skyrocket' ),
				'description' => esc_html__( 'Select the font that you\'d like to use for your headings.', 'skyrocket' ),
				'panel' => 'typography_panel'
			)
		);

		/**
		 * Add our H1 Heading Section
		 */
		$wp_customize->add_section( 'h1_heading_section',
			array(
				'title' => __( 'Heading 1 (H1)', 'skyrocket' ),
				'description' => esc_html__( 'Select the styles that you\'d like to use for your H1 headings.', 'skyrocket' ),
				'panel' => 'typography_panel'
			)
		);
	 ...
	 */
	public function skyrocket_register_body_text_controls( $wp_customize ) {
		// Add our Google Font Control for getting the Body text font
		$wp_customize->add_setting( 'sample_body_text_font',
			array(
				'default' => $this->defaults['sample_body_text_font'],
				'sanitize_callback' => 'skyrocket_google_font_sanitization'
			)
		);
		$wp_customize->add_control( new Skyrocket_Google_Font_Select_Custom_Control( $wp_customize, 'sample_body_text_font',
			array(
				'label' => __( 'Body Text Font', 'skyrocket' ),
	 ...
	 */
	public function skyrocket_register_heading_controls( $wp_customize ) {
		// Add our Google Font Control for getting the Heading font
		$wp_customize->add_setting( 'sample_heading_font',
			array(
				'default' => $this->defaults['sample_heading_font'],
				'sanitize_callback' => 'skyrocket_google_font_sanitization'
			)
		);
		$wp_customize->add_control( new Skyrocket_Google_Font_Select_Custom_Control( $wp_customize, 'sample_heading_font',
			array(
				'label' => __( 'Heading Font', 'skyrocket' ),
	...
	public function skyrocket_register_h1_heading_controls( $wp_customize ) {
		...
		$wp_customize->add_setting( 'sample_h1_heading_style',
			array(
				'default' => $this->defaults['sample_h1_heading_style'],
				'transport' => 'refresh',
				'sanitize_callback' => 'skyrocket_radio_sanitization'
			)
		);
		$wp_customize->add_control( 'sample_h1_heading_style',
			array(
				'label' => __( 'Style', 'skyrocket' ),
				'section' => 'h1_heading_section',
				'type' => 'select',
				'choices' => array(
					'normal' => __( 'Normal', 'skyrocket' ),
					'italic' => __( 'Italic', 'skyrocket' ),
				)
			)
		);

 		// Add our Select Control for getting the H1 Heading Weight selection
		$wp_customize->add_setting( 'sample_h1_heading_weight',
			array(
				'default' => $this->defaults['sample_h1_heading_weight'],
				'transport' => 'refresh',
				'sanitize_callback' => 'skyrocket_radio_sanitization'
			)
		);
		$wp_customize->add_control( 'sample_h1_heading_weight',
			array(
				'label' => __( 'Weight', 'skyrocket' ),
				'section' => 'h1_heading_section',
				'type' => 'select',
				'choices' => array(
					'normal' => __( 'Normal', 'skyrocket' ),
					'bold' => __( 'Bold', 'skyrocket' ),
				)
			)
		);

 		// Add our Select Control for getting the H1 Heading Text Transform selection
		$wp_customize->add_setting( 'sample_h1_heading_text_transform',
			array(
				'default' => $this->defaults['sample_h1_heading_text_transform'],
				'transport' => 'refresh',
				'sanitize_callback' => 'skyrocket_radio_sanitization'
			)
		);
		$wp_customize->add_control( 'sample_h1_heading_text_transform',
			array(
				'label' => __( 'Text Transform', 'skyrocket' ),
				'section' => 'h1_heading_section',
				'type' => 'select',
				'choices' => array(
					'none' => __( 'None', 'skyrocket' ),
					'lowercase' => __( 'Lowercase', 'skyrocket' ),
					'uppercase' => __( 'Uppercase', 'skyrocket' ),
					'capitalize' => __( 'Capitalize', 'skyrocket' )
				)
			)
		);

		// Add our Select Control for getting the H1 Heading Line Height selection
		$wp_customize->add_setting( 'sample_h1_heading_line_height',
			array(
				'default' => $this->defaults['sample_h1_heading_line_height'],
				'transport' => 'refresh',
				'sanitize_callback' => 'skyrocket_range_sanitization'
			)
		);
		$wp_customize->add_control( new Skyrocket_Slider_Custom_Control( $wp_customize, 'sample_h1_heading_line_height',
			array(
				'label' => __( 'Line Height', 'skyrocket' ),
				'section' => 'h1_heading_section',
				'input_attrs' => array(
					'min' => 1,
					'max' => 4,
		...
		// Add our Color Control for getting the H1 Heading normal color
		$wp_customize->add_setting( 'sample_h1_heading_color_normal',
			array(
				'default' => $this->defaults['sample_h1_heading_color_normal'],
				'transport' => 'refresh',
		...
		// Add our Color Control for getting the H1 Heading link color
		$wp_customize->add_setting( 'sample_h1_heading_color_link',
			array(
				'default' => $this->defaults['sample_h1_heading_color_link'],
				'transport' => 'refresh',
				'sanitize_callback' => 'skyrocket_hex_rgba_sanitization',
			)
		);
		...
		// Add our Color Control for getting the H1 Heading hover color
		$wp_customize->add_setting( 'sample_h1_heading_color_hover',
			array(
				'default' => $this->defaults['sample_h1_heading_color_hover'],
				'transport' => 'refresh',
				'sanitize_callback' => 'skyrocket_hex_rgba_sanitization',
			)
		);
		...
		// Add our Color Control for getting the H1 Heading visited color
		$wp_customize->add_setting( 'sample_h1_heading_color_visited',
			array(
				'default' => $this->defaults['sample_h1_heading_color_visited'],
				'transport' => 'refresh',
				'sanitize_callback' => 'skyrocket_hex_rgba_sanitization',
			)
		);
